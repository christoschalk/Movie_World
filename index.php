   ...
   <div class="row">
	...
	<h1><a href="index.php">Movie World</a></h1>
	   <?php
	     ...
	     $query = "SELECT movie_id FROM movies ORDER BY movie_id";  
			...
			while($movieRows=mysqli_fetch_array($getMoviesResult))
			{
			   ...
			   $userFullName=$userFirstName.' '. $userLastName;	
				...
				if (isset ($_SESSION['logged_in']))
				{
				  ...
				  echo '<br>Welcome Back:<a href="user_movies.php?movieSelectedUserId='.$loggedUserId.'"> '.$logginUserFullName.'</a>';
				}
				else
				{
	...
	<?php
	 ...
	 if (isset ($_SESSION['logged_in']))
	 {
	  ...
	  <div class="filter-box">
		...
		<a href="index.php"><button type="submit" class="btn btn-primary btn-sm">Reset</button></a>
